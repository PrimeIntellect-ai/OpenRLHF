...
def reward_func(queries, prompts, reward_infos):
    rewards = []
    for q, r in tqdm(zip(queries, reward_infos)):
        reward_info = ast.literal_eval(r)        
        correct = verify_math_sample(q, reward_info["ground_truth"])
